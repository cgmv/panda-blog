...
BLOG_AUTHOR = "Chris Viola"  # (translatable)
BLOG_TITLE = "Panda Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.itoaster.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://blog.itoaster.net/"
BLOG_EMAIL = "info@itoaster.net"
BLOG_DESCRIPTION = "Tech Blog"  # (translatable)
